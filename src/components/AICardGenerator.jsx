...
// Add this after all your state declarations
const isMounted = useRef(true);

// Add this useEffect at the top of your other effects
useEffect(() => {
  ...
  return () => {
    ...
    console.log("AICardGenerator unmounting, cleaning up state updates");
  };
